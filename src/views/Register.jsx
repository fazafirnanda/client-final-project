        ...
        <div className="shadow-lg p-7 w-[29rem]">
            <form action="" className="flex flex-col gap-y-4">
                ...
                <div className="flex border shadow-none border-black focus:shadow-lg">
                    ...
                    <input type="text" placeholder="John doe" className="min-w-72 p-3 outline-none"/>
                </div>
                ...
                <button type="submit" className="p-3 bg-[#566bad] rounded-md text-white">Register</button>
                <div className="flex justify-end">
                    <p>Already have a account ? <Link to="/login" className="text-[#3e01ff]">Login</Link></p>
                </div>
            </form>
        </div>
    </div>
